...
function gerarNumeroAleatorio() {
    ...
    if (quantidadeDeElementosNaLista == 3) { // Se atingir 3, limpamos a lista para evitar bugs
        listaDeNumerosSorteados = [];
    }
    if (listaDeNumerosSorteados.includes(numeroEscolhido)) {
        return gerarNumeroAleatorio();
    } else {
        listaDeNumerosSorteados.push(numeroEscolhido); // .push adiciona ao final da lista
